...
class _AppServiceClient implements AppServiceClient {
  ...
  Future<BaseResponse<LoginResponse, String>> loginWithQrCode(
    ...
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = {'qrCode': token};
    final _options = _setStreamType<BaseResponse<LoginResponse, String>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/NativeApp/loginWithQrCode',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponse<LoginResponse, String> _value;
    try {
      _value = BaseResponse<LoginResponse, String>.fromJson(
        _result.data!,
        (json) => LoginResponse.fromJson(json as Map<String, dynamic>),
        (json) => json as String,
      );
